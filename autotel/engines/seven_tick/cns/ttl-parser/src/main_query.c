...
int main(int argc, char* argv[]) {
    ...
    // Use the real parser to parse the TTL file
    ...
    Parser *parser = ttl_parser_create_from_file(input_file, &parser_opts);
    fclose(input_file);
    ...
    // Get the AST context from the parser (this is crucial!)
    ttl_ast_context_t *context = parser->ast_context;
