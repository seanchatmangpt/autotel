...
cns_result_t cns_telemetry_init(
...
cns_result_t cns_telemetry_flush(cns_telemetry_t* telemetry);
...
#define CNS_TELEMETRY_COMMAND(telemetry, cmd_name, code) \
    do { \
        ...
        cns_span_end(_span, __result == CNS_OK ? \
            CNS_SPAN_STATUS_OK : CNS_SPAN_STATUS_ERROR); \
    } while(0)
