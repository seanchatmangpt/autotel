...
const char *cns_shacl_constraint_type_string(cns_shacl_constraint_type_t type)
{
  ...
  case CNS_SHACL_CONSTRAINT_CLASS:
    return "class";
  case CNS_SHACL_CONSTRAINT_DATATYPE:
    return "datatype";
  case CNS_SHACL_CONSTRAINT_NODE_KIND:
    return "node-kind";
  case CNS_SHACL_CONSTRAINT_MIN_LENGTH:
    return "min-length";
  case CNS_SHACL_CONSTRAINT_MAX_LENGTH:
    return "max-length";
  case CNS_SHACL_CONSTRAINT_PATTERN:
    return "pattern";
  case CNS_SHACL_CONSTRAINT_IN:
    return "in";
  default:
    return "unknown";
  }
...
const char *cns_shacl_result_level_string(cns_shacl_result_level_t level)
{
  switch (level)
  {
  case CNS_SHACL_RESULT_INFO:
    return "info";
  case CNS_SHACL_RESULT_WARNING:
    return "warning";
  case CNS_SHACL_RESULT_VIOLATION:
    return "violation";
  case CNS_SHACL_RESULT_MEMORY_VIOLATION:
