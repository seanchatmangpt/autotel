...
int main() {
    ...
    for (int i = 0; i < 4; i++) simd_data[i] = i + 1;
    ...
    for (int i = 0; i < 8; i++) cache_line[i] = i * 0x1111111111111111ULL;
    ...
    if (hash_perf.meets_8t_constraint) operations_meeting_8t++;
    if (simd_perf.meets_8t_constraint) operations_meeting_8t++;
    if (cache_perf.meets_8t_constraint) operations_meeting_8t++;
