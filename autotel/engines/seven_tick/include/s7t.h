...
#ifdef S7T_DEBUG
#define S7T_ASSERT_CYCLES(operation, max_cycles)    \
    do                                              \
    {                                               \
...
S7T_ALWAYS_INLINE void s7t_perf_update(s7t_perf_counter_t *perf, uint64_t cycles)
{
    if (cycles < perf->min_cycles)
...
// s7t_hash_string already defined above

/*— Performance Monitoring —*/
// s7t_perf_counter_t and s7t_perf_update already defined above
