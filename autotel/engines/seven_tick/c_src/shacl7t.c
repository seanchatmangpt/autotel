...
int shacl_validate_node(ShaclEngine* e, uint32_t node_id, uint32_t shape_id) {
    ...
    if (!target_match) return 1; // Not targeted by this shape      // Tick 5: branch
