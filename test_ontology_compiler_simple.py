#!/usr/bin/env python3
"""
Simple OntologyCompiler test without telemetry flooding.
"""
...
def suppress_telemetry():
    """Suppress telemetry output during test."""
...
def test_ontology_compiler_simple():
    """Test OntologyCompiler with suppressed telemetry output."""
    
    print("🧪 Testing OntologyCompiler (Simple)")
    print("=" * 40)
    ...
    try:
        ...
        # Parse OWL with processor (suppress telemetry output)
        ...
        # Compile with OntologyCompiler (suppress telemetry output)
        ...
        output_file = "compiled_ontology_simple.json"
...
if __name__ == "__main__":
    success = test_ontology_compiler_simple()
    if success:
        print("\n🎉 OntologyCompiler simple test PASSED!")
    else:
        print("\n💥 OntologyCompiler simple test FAILED!")
        sys.exit(1) 